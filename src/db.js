...
dialectOptions: {
  ...
  ssl: true,
}): new Sequelize( `postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/vzlc`, {logging:false,native: false})
...
const {User, Comment, Project, Quote, Rating, Role } = sequelize.models;

User.hasMany(Quote)
Quote.belongsToMany(User, {through: 'user_quote'})
